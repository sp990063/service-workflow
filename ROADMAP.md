...
**Status:** 未實現  
**檔案:** `backend/src/workflows/workflow-engine.service.ts` (new)

**需要做：**
- [ ] Parallel node execution (AND/OR logic)
- [ ] Sequential node execution
- [ ] Condition evaluation (if/else branches)
- [ ] Sub-workflow invocation
- [ ] State machine for workflow instance

**驗收標準：**
- [ ] Parallel approval workflow 可以同時發給多個審批人
- [ ] Condition node 可以根據表單數據分支
- [ ] Instance history 記錄每個步驟
